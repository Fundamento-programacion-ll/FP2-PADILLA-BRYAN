...
Connection con=cc.con;
    ...
    public login() {
       ...
       ((JPanel)getContentPane()).setOpaque(false);
        ImageIcon uno=new ImageIcon(this.getClass().getResource("/Imagenes/pokemon-2_opt.jpg"));
   ...
   // }
    ...
    private void initComponents() {
        ...
        bt_inicio.setBackground(new java.awt.Color(0, 255, 204));
        bt_inicio.setFont(new java.awt.Font("Bungee Inline", 1, 12)); // NOI18N
        ...
        bt_reg.setFont(new java.awt.Font("Bungee Inline", 1, 12)); // NOI18N
        ...
        jLabel4.setFont(new java.awt.Font("Bungee Inline", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 0));
        jLabel4.setText("BIENVENIDO POKEMON ");

        jLabel1.setFont(new java.awt.Font("Bungee Inline", 0, 18)); // NOI18N
...
this.dispose();
    ...
    int resultado=0;
        try {
            ...
            String sql= "select * from usu where user='"+usuario+"' and contraseña='"+pass+"'";
        ...
        Intefaz_principal It = new Intefaz_principal();
    It.setVisible(true);
    this.dispose();
