...
public class Interfaz_asignar extends javax.swing.JInternalFrame {
    ...
    public Interfaz_asignar(control_asignar ctr) {
        ...
        jTextField_nombres.setText(ctr.ingresa_nombre_entrenador());
        jTextField_apellidos.setText(ctr.ingresa_apellido_entrenador());
        jTextField_carnet.setText(ctr.ingresa_carnet_entrenador());
    ...
    private void initComponents() {
        ...
        jComboBox_materia.setForeground(new java.awt.Color(102, 102, 255));
        ...
        jButton_registrar.setBackground(new java.awt.Color(255, 255, 0));
        jButton_registrar.setFont(new java.awt.Font("Lemon", 0, 11)); // NOI18N
        jButton_registrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icono/Ultra_Ball_icon-icons.com_67500.png"))); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("Lemon", 0, 11)); // NOI18N
    ...
    private void jButton_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_registrarActionPerformed
        ...
        {
        JOptionPane.showMessageDialog(this, "Se asigno el pokemon con exito"); 
        }
        else
    {
      JOptionPane.showMessageDialog(this, "El pokemon ya ha sido asignada");  
    }
    
        String[] columnas = {"Codigo Entrenador","Pokemon"};
    ...
    if(jComboBox_materia.getSelectedItem()!=null )
     {
            ...
            Object[][] datos = ctr.ingresa_codpoke(jComboBox_materia.getSelectedItem().toString());
